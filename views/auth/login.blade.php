                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('login') }}" class="needs-validation"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <div class="regis float-right m-1">
                                            <p class=""><a href="/forgot" style="text-decoration: none; color:rgb(146, 146, 146); ">forgot password?</a></p>
                                        </div>
                                    ...
                                    <div class="regis d-flex">
                                        <p class="m-auto">Don't have an account? <a href="/signup" style="text-decoration: none">Create your account</a></p>
                                    </div>
                                </form>
